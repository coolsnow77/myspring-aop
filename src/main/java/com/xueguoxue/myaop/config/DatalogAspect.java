...
import com.xueguoxue.myaop.domain.ActionType;
import com.xueguoxue.myaop.domain.ChangeItem;
import com.xueguoxue.myaop.utils.DiffUtil;
import com.xueguoxue.myaop.dao.ActionDao;
import com.xueguoxue.myaop.domain.ActionType;
import com.xueguoxue.myaop.domain.ChangeItem;
...
public class DatalogAspect {
    ...
    @Pointcut("execution(public * com.xueguoxue.myaop.dao.*.save*(..))")
    public void save(){

    }

    @Pointcut("execution(public * com.xueguoxue.myaop.dao.*.delete*(..))")
    public void delete(){
